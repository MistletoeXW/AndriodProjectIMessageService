package com.example.demo.utils.getui;
...
public class PushDispatcher {
    private static final String appId = "Qm4TMlqKfR8vbB7cf8b7C1";
    private static final String appKey = "qyHeU0WREZ81zNhYgZFly1";
    private static final String masterSecret = "89FfbWmKPO6YLXIQPZM8X7";
